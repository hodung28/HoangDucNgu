...
public class HDN_Blockchain {
    public static ArrayList<VNPT_Ngu> blockchain = new ArrayList<VNPT_Ngu>();
    ...
    public static void main(String[] args) {
        ...
        VNPT_Ngu genesis = new VNPT_Ngu("0");
        ...
        do {
            VNPT_Ngu block1 = blockchain.get(blockchain.size()-1);
            //VNPT_Ngu block1 = new VNPT_Ngu(genesis.hash);
            VNPT_Ngu block2 = new VNPT_Ngu(block1.hash);
    ...
    public static Boolean isChainValid() {
        VNPT_Ngu currentBlock;
        VNPT_Ngu previousBlock;
    ...
    public static void addBlock(VNPT_Ngu newBlock) {
